...
public class RelicDescriptionsFixPatches {
    ...
    public static class FontHelperRenderSmartTextPatch {
        ...
        public static void CardTitleFontInsert(SpriteBatch sb, BitmapFont font, String msg, float x, float y, float lineWidth, float lineSpacing, Color baseColor, @ByRef String word[]) {
        ...
        public static void CardTitleFontInsert(SpriteBatch sb, BitmapFont font, String msg, float x, float y, float lineWidth, float lineSpacing, Color baseColor, @ByRef float curWidth[], float spaceWidth) {
            if (removeSpace) {
    ...
    public static class FontHelperGetSmartHeightPatch {
        ...
        @SpireInsertPatch(locator = RemoveSpecialWordLocator.class, localvars = {"word"})
        public static void CardTitleFontInsert(BitmapFont font, String msg, float lineWidth, float lineSpacing, @ByRef String word[]) {
            if (word[0].startsWith(BLACKBEARD_REMOVE_SPACE)) {
                word[0] = word[0].replace(BLACKBEARD_REMOVE_SPACE, StringUtils.EMPTY);
            }
        }
