...
public class DamageCurvyEffect extends DamageImpactCurvyEffect {
    public DamageCurvyEffect(float x, float y, Color color) {
    ...
    public DamageCurvyEffect(float x, float y, Color color, float duration, float speed, float waveIntensity, float waveSpeed) {
