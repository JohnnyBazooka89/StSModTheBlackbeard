...
public class BrownPants extends AbstractBlackbeardCard {
    public static final String ID = makeID("BrownPants");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    private static final int COST = 2;
    private static final int PLATED_ARMOR_VALUE = 5;
    private static final int UPGRADE_PLUS_PLATED_ARMOR_VALUE = 1;
    ...
    public void upgrade() {
        if (!this.upgraded) {
            this.upgradeName();
            this.upgradeMagicNumber(UPGRADE_PLUS_PLATED_ARMOR_VALUE);
        }
    }
}
