...
public class PirateEarring extends AbstractBlackbeardCard {
    public static final String ID = "blackbeard:PirateEarring";
    ...
    public PirateEarring() {
        ...
        this.baseMagicNumber = this.magicNumber = ARTIFACT_VALUE;
    }
