...
public class CaptainsHat extends AbstractBlackbeardCard {
    ...
    private static final int RESISTANCE_AMOUNT = 2;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new ResistancePower(p, RESISTANCE_AMOUNT), RESISTANCE_AMOUNT));
    }
