...
public abstract class AbstractBlackbeardCard extends CustomCard {
    ...
    public static Texture cannonTex = TextureLoader.getTexture("blackbeard/img/relics/Cannonball.png");

    public static Texture goldenCannonTex = TextureLoader.getTexture("blackbeard/img/relics/GoldenCannonball.png");

    public static Texture hugeCannonTex = TextureLoader.getTexture("blackbeard/img/relics/HumongousCannonball.png");
