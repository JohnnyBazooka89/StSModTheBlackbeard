...
This mod adds a new character for Slay the Spire, named The Blackbeard, with 75+ new cards and 16 new relics (1 starter, 5 common, 4 uncommon, 2 rare, 3 boss and 1 shop). 
...
The Blackbeard has access to 3 character-specific potions, one for each rarity, similar to the base game characters.
